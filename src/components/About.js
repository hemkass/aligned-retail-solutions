      ...
      <div className="bloc">
        <div className="bloc1">
          <h1>
            ...
            for customers of all scope and sizes in North America and in Europe.
          </h1>
        </div>
        <div className="bloc2">
          <div>
            <div className="profil-box">
              <div className="profil-img-box">
                {" "}
                {/*        <img
                  className="miniature-profil-rond"
                  src="https://res.cloudinary.com/dyj84szrx/image/upload/v1643026775/ricky/1597248041722_ringk6.jpg"
                  alt="profil de Ricky"
                ></img> */}
              </div>
              <div className="profil-description-box">
                <div>
                  <h3>Our Principal, Ricky Glass</h3>
                </div>
                <div>
                  <p>
                ...
                <div>
                  <h6>(include link to my personal Linked In page)</h6>
                </div>{" "}
                <div>
                  <h5>
